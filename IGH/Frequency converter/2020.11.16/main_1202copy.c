...
static unsigned int ECT_Command[fre_count];
static unsigned int ECT_Frequency[fre_count];

static unsigned int ECT_Status[fre_count];
static unsigned int ECT_Output_frequency[fre_count];
...
ec_pdo_entry_reg_t domainServoOutput_regs[] = {
    ...
    {MX2ECT_Pos, MX2ECT, 0x5000, 0x00, &ECT_Command[0], NULL},
    {MX2ECT_Pos, MX2ECT, 0x5010, 0x00, &ECT_Frequency[0], NULL},
    {}};
ec_pdo_entry_reg_t domainServoInput_regs[] = {
    ...
    {MX2ECT_Pos, MX2ECT, 0x5100, 0x00, &ECT_Status[0], NULL},
    {MX2ECT_Pos, MX2ECT, 0x5110, 0x00, &ECT_Output_frequency[0], NULL},
    {}};
/****************************************************************************/
