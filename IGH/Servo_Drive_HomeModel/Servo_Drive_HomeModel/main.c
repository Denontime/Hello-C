...
int csp_speed[drive_count] = {2500};           //csp转动速率
...
#define asda 0x00000083, 0x00000053
...
void DriverEtherCAT()
{
    ...
    default:
    {
        ...
        //     for (int i = 0; i < drive_count; i++)
        //     {
        //         if (EC_READ_U16(domainInput_pd + errcode[i]) != 0 || (cur_status & 0x0008))
        //         {
        //             EC_WRITE_U16(domainOutput_pd + cntlwd[i], (EC_WRITE_U16(domainOutput_pd + cntlwd[i]) | 0x0080));
        //         }
        //         else
        //         {
        //             EC_WRITE_U16(domainOutput_pd + cntlwd[i], (EC_WRITE_U16(domainOutput_pd + cntlwd[i]) & 0xff7f));
        //             ServoFaultReset = 0;
        //         }
        //     }
        // }
